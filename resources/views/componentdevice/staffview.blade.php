        ...
        <div class="dashboard-header">
            ...
            <div class="header-right">
                <div class="header-actions">
                    @if(!$component->is_active)
                        <a href="{{ route('staff.component.edit', $component->compID) }}" class="btn btn-warning">
                            <i class="fas fa-edit"></i> Edit Component
                        </a>
                        <button type="button" class="btn btn-danger" id="requestDeletionBtn">
                            <i class="fas fa-trash"></i> Request Deletion
                        </button>
                    @else
                        <span class="btn btn-secondary disabled" title="Active components can only be modified by administrators">
                            <i class="fas fa-lock"></i> Locked (Active)
                        </span>
                    @endif
                ...
                <div class="component-details">
                    ...
                    <div class="details-card">
                        <div class="card-header">
                            <h4><i class="fas fa-info-circle"></i> Component Status</h4>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="status-item">
                                    ...
                                    <div class="status-display">
                                        @if($component->is_active)
                                            ...
                                            <small class="status-description">This component is approved and available for use in recommendations.</small>
                                        @else
                                            <span class="status-badge badge badge-warning">
                                                <i class="fas fa-clock"></i> Pending Approval
                                            </span>
                                            <small class="status-description">This component is waiting for administrator approval before it can be used.</small>
                                        @endif
                                    </div>
                                </div>
                    ...
                    <div class="details-card">
                        <div class="card-header">
                            <h4><i class="fas fa-clipboard-list"></i> Component Details</h4>
                        </div>
                        <div class="card-body">
                    ...
                    <!-- Permissions Notice Card -->
                    @if($component->is_active)
                    <div class="details-card permissions-notice">
                        <div class="card-header">
                            <h4><i class="fas fa-shield-alt"></i> Access Permissions</h4>
                        </div>
                        <div class="card-body">
                            <div class="permission-info">
                                ...
                                <div class="permission-content">
                                    <h5>Component is Active - Limited Access</h5>
                                    <p>This component has been approved and is currently active. As a staff member, you can view all details but cannot modify active components. Please contact an administrator if changes are needed.</p>
                                    <div class="permission-actions">
                                        <span class="permission-badge read-only">
                    ...
                    @else
                    <div class="details-card permissions-notice pending">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                            <div class="permission-info">
                                ...
                                <div class="permission-content">
                                    <h5>Component Awaiting Approval</h5>
                                    <p>This component is pending administrator approval. You can edit or request deletion while it's in pending status. Once approved, only administrators can make changes.</p>
                                    <div class="permission-actions">
                                        <span class="permission-badge editable">
                                            <i class="fas fa-edit"></i> Can Edit
                                        </span>
                                        <span class="permission-badge deletable">
                                            <i class="fas fa-trash"></i> Can Request Deletion
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Are you sure you want to request deletion for "<strong>{{ $component->name }}</strong>"?</p>
                <p class="text-warning"><i class="fas fa-exclamation-triangle"></i> This will send a deletion request to the administrator for review.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                <form action="{{ route('staff.component.request-deletion', $component->compID) }}" method="POST" style="display: inline;">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Modal functionality for deletion request
    const requestDeletionBtn = document.getElementById('requestDeletionBtn');
    
    if (requestDeletionBtn) {
        requestDeletionBtn.addEventListener('click', function() {
            $('#requestDeletionModal').modal('show');
        });
    }
...
<style>
/* Staff Component View Specific Styles */
:root{
    --blue: #7d7deb;
    --black: #333;
    --white: #fff;
...
.details-card.permissions-notice {
    border-left-color: var(--warning-color);
}

.details-card.permissions-notice.pending {
...
.permissions-notice.pending .permission-icon {
    background-color: var(--info-color);
}
