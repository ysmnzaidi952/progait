    ...
    <main class="dashboard-main">
        <div class="dashboard-header">
            ...
            <div class="header-right">
                <div class="header-actions">
                    <a href="{{ route('admin.component.show', $component->compID) }}" class="btn btn-info">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('admin.component.update', $component->compID) }}" method="POST" class="component-form" id="componentForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        <h3 class="section-title">
                            <i class="fas fa-toggle-on"></i> Status & Metadata
                        </h3>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="is_active" name="is_active" class="form-control @error('is_active') is-invalid @enderror" required>
                                    ...
                                    <option value="1" {{ old('is_active', $component->is_active) == '1' ? 'selected' : '' }}>Active (Available for use)</option>
                                    <option value="0" {{ old('is_active', $component->is_active) == '0' ? 'selected' : '' }}>Inactive (Not available)</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('admin.component.index') }}" class="btn btn-secondary">
