    ...
    <main class="dashboard-main">
        <div class="dashboard-header">
            <div class="header-left">
                ...
                <p class="info-notice">
                    ...
                    Components created by staff will be pending approval until reviewed by an administrator.
                </p>
            </div>
            <div class="header-right">
                <div class="header-notifications">
                    <div class="notifications-icon">
                        <a href="{{ route('staff.component.index') }}" class="link-btn">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('staff.component.store') }}" method="POST" class="component-form" id="componentForm">
                    @csrf
                    ...
                    <!-- Approval Notice Section -->
                    <div class="form-section approval-notice">
                        <h3 class="section-title">
                            <i class="fas fa-clock"></i> Approval Process
                        </h3>
                            ...
                            <div class="approval-steps">
                                <div class="step">
                                    ...
                                    <div class="step-content">
                                        <h5>1. Component Creation</h5>
                                        <p>Your component will be created with "Pending Approval" status</p>
                                    </div>
                                </div>
                                <div class="step">
                                    <div class="step-icon">
                                    ...
                                    <div class="step-content">
                                        <h5>2. Administrator Review</h5>
                                        <p>An administrator will review the component details</p>
                                    </div>
                                </div>
                                <div class="step">
                                    <div class="step-icon">
                                    ...
                                    <div class="step-content">
                                        <h5>3. Approval & Activation</h5>
                                        <p>Once approved, the component becomes active and available for use</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Create Component (Pending Approval)
                        </button>
...
<style>
/* Staff Component Create Specific Styles */
:root{
    --blue: #7d7deb;
    --black: #333;
    --white: #fff;
