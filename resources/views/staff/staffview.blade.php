...
<head>
    ...
    <title>ProGait - Staff Details</title>
            ...
            <div class="header-right">
                ...
                <div class="header-notifications">
                    <div class="notifications-icon">
                        <a href="{{ route('admin.dashboard') }}" class="link-btn">Home</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="content-container">
                ...
                <div class="profile-view-header">
                    ...
                    <div class="profile-actions">
                        <a href="{{ route('admin.staff.edit', $staff->staffID) }}" class="btn btn-primary">
                ...
                <div class="appointment-actions">
                    <a href="{{ route('admin.stafflist') }}" class="btn btn-primary">
                        <i class="fas fa-arrow-left"></i> Back to Staff List
                    </a>
                    @if($staff->status == 'pending')
                    <form action="{{ route('admin.staff.approve', $staff->staffID) }}" method="POST" style="display: inline;">
                        @csrf
                        @method('PATCH')
                        <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to approve this staff member?')">
...
<style>
    ...
    .btn-success:hover {
        ...
        transform: translateY(-3px);
        box-shadow: 0 4px 10px rgba(75, 210, 143, 0.3);
        color: var(--white);
        text-decoration: none;
    }
