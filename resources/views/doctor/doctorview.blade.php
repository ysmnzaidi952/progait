            ...
            <div class="content-container">
                ...
                <div class="profile-view-header">
                    ...
                    <div class="profile-actions">
                        <a href="{{ route('admin.doctor.edit', $doctor->docID) }}" class="btn btn-primary">
                            <i class="fas fa-edit"></i> Edit Profile
                        </a>
                        @if($doctor->status == 'pending')
                        <form action="{{ route('admin.doctor.approve', $doctor->docID) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to approve this doctor?')">
                ...
                <div class="appointment-actions">
                    <a href="{{ route('admin.doctor.doctorlist') }}" class="btn btn-primary">
