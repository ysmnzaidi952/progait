...
<head>
    ...
    <title>ProGait - Update Doctor</title>
    ...
    <main class="dashboard-main">
        <div class="dashboard-header">
            <div class="header-left">
                <h2 class="page-title">Update Doctor Details</h2>
                <p class="header-subtitle">Modify doctor information and personal details</p>
            </div>
        </div>
        ...
        <div class="dashboard-content">
            <div class="update-form-container">
                ...
                <form action="{{ route('staff.doctor.updatestaff', $doctor->docID) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="docName"><i class="fas fa-user"></i> Full Name</label>
                                <input type="text" class="form-control" id="docName" name="docName" 
                                       value="{{ old('docName', $doctor->docName) }}" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="docIC"><i class="fas fa-id-card-alt"></i> IC Number</label>
                                <input type="text" class="form-control" id="docIC" name="docIC" 
                                       value="{{ old('docIC', $doctor->docIC) }}" required 
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="docEmail"><i class="fas fa-envelope"></i> Email Address</label>
                                <input type="email" class="form-control" id="docEmail" name="docEmail" 
                                       value="{{ old('docEmail', $doctor->docEmail) }}" required>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="docTel"><i class="fas fa-phone"></i> Phone Number</label>
                                <input type="text" class="form-control" id="docTel" name="docTel" 
                                       value="{{ old('docTel', $doctor->docTel) }}" required 
                    ...
                    <div class="update-form-actions">
                        ...
                        <a href="{{ route('staff.doctor.doctorliststaff') }}" class="btn btn-secondary">
