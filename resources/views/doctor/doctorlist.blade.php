...
<head>
    ...
    <title>ProGait - Manage Doctors</title>
    ...
    <main class="dashboard-main">
        <div class="dashboard-header">
            ...
            <div class="header-right">
                ...
                <a href="{{ route('doctor.register.show') }}" class="add-staff-btn">
        ...
        <div class="dashboard-content">
            ...
            <div class="staff-table-container">
                ...
                <div class="table-responsive">
                    <table class="staff-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><span class="staff-id">{{ $doctor->docID }}</span></td>
                                <td>
                                    <div class="staff-name">
                                        <div class="staff-avatar">
                                            <span>{{ substr($doctor->docName, 0, 1) }}</span>
                                        </div>
                                        <span>{{ $doctor->docName }}</span>
                                    </div>
                                </td>
                                <td>{{ $doctor->docEmail }}</td>
                                <td><span class="staff-role role-doctor">Doctor</span></td>
                                <td>{{ $doctor->docTel }}</td>
                                <td>
                                    <div class="staff-actions">
                                        <a href="{{ route('admin.doctor.view', $doctor->docID) }}" class="action-btn view-btn" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.doctor.edit', $doctor->docID) }}" class="action-btn edit-btn" title="Edit Doctor">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('admin.doctor.delete', $doctor->docID) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="action-btn delete-btn" title="Delete Doctor" onclick="return confirm('Are you sure you want to delete {{ $doctor->docName }}? This action cannot be undone.')">
                ...
                <div class="empty-state">
                    ...
                    <p>There are no doctors in the database yet.</p>
                    <a href="{{ route('doctor.register.show') }}" class="link-btn">Add New Doctor</a>
                </div>
                @endif
