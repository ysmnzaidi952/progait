            ...
            <div class="content-container">
                ...
                <div class="reminder-layout">
                    ...
                    <div class="reminder-left-panel">
                        <form action="{{ route('admin.reminder.store') }}" method="POST" class="reminder-form" id="reminderForm">
                            @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function checkDateAvailability(selectedDate) {
        ...
        fetch(`/admin/reminder/check-availability/${selectedDate}`)
    ...
    function fetchBookedDates() {
        fetch(`/admin/reminder/booked-dates/${currentYear}/${currentMonth + 1}`)
            .then(response => response.json())
            .then(data => {
