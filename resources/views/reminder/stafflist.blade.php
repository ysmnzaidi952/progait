            ...
            <div class="dashboard-content">
                <div class="content-container">
                    <div class="reminder-header">
                        ...
                        <div class="add-new">
                            <a href="{{ route('staff.reminder.create') }}" class="add-reminder-btn">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center">
                                            <div class="empty-state">
                                                ...
                                                <a href="{{ route('staff.reminder.create') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#deleteModal').on('show.bs.modal', function(event) {
                ...
                modal.find('#deleteForm').attr('action', `/staff/reminder/${reminderId}`);
            });
        ...
        function sendReminder(id, patientName, firstStatus, secondStatus, thirdStatus) {
            ...
            document.getElementById('sendReminderForm').action = `/staff/reminder/send/${id}`;
