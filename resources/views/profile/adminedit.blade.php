...
<head>
    ...
    <title>ProGait - Edit Admin Profile</title>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('admin.profile.update') }}" method="POST" class="profile-edit-form" id="profileForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i> Account status is managed by system administrators
                                </small>
                            </div>
                        </div>
                    </div>
