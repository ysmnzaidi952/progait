    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('patient.profile.update') }}" method="POST" class="profile-edit-form" id="profileForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" 
                                       ...
                                       id="patientName" 
                                       name="patientName" 
                                       value="{{ old('patientName', $patient->patientName) }}" 
                                       required>
                                @error('patientName')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="patientIC">NRIC / Passport Number</label>
                                <input type="text" 
                                       class="form-control" 
                                       id="patientIC" 
                                       name="patientIC" 
                                       value="{{ $patient->patientIC }}" 
                                       readonly>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       readonly>
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i> Patient ID is automatically assigned
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="email" 
                                       class="form-control @error('patientEmail') is-invalid @enderror" 
                                       id="patientEmail" 
                                       name="patientEmail" 
                                       value="{{ old('patientEmail', $patient->patientEmail) }}" 
                                       required>
                                @error('patientEmail')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-envelope"></i> This email will be used for appointment notifications
                                </small>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="patientTel">Phone Number <span class="required">*</span></label>
                                <input type="tel" 
                                       class="form-control @error('patientTel') is-invalid @enderror" 
                                       id="patientTel" 
                                       name="patientTel" 
                                       value="{{ old('patientTel', $patient->patientTel) }}" 
                                       required>
                                @error('patientTel')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          name="address" 
                                          rows="4" 
                                          placeholder="Enter your full address">{{ old('address', $patient->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                    ...
                    <div class="form-section">
                        ...
                        <div class="security-info">
                            ...
                            <div class="security-item">
                                ...
                                <div class="security-content">
                                    <h5>Last Updated</h5>
                                    <p>Profile was last updated on {{ $patient->updated_at->format('d/m/Y h:i A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-buttons">
                        ...
                        <a href="{{ route('patient.profile') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const phoneInput = document.getElementById('patientTel');
