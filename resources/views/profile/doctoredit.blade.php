                ...
                <div class="profile-edit-header">
                    <div class="profile-avatar-section">
                        ...
                        <div class="profile-info">
                            ...
                            <p class="doctor-name">Dr. {{ $doctor->docName }}</p>
                            <p class="doctor-id">
                                <i class="fas fa-hashtag"></i> 
                                Doctor ID: {{ $doctor->docID }}
                            </p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('doctor.profile.update') }}" method="POST" class="profile-edit-form" id="profileForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label for="docName">Full Name <span class="required">*</span></label>
                                <input type="text" 
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="date" 
                                       ...
                                       id="dateOfBirth" 
                                       name="dateOfBirth" 
                                       value="{{ old('dateOfBirth', $doctor->dateOfBirth) }}">
                                @error('dateOfBirth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-calendar"></i> Your date of birth
                                </small>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-venus-mars"></i> Your gender identity
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('race') is-invalid @enderror" 
                                    ...
                                    <option value="Malay" {{ old('race', $doctor->race) == 'Malay' ? 'selected' : '' }}>Malay</option>
                                    <option value="Chinese" {{ old('race', $doctor->race) == 'Chinese' ? 'selected' : '' }}>Chinese</option>
                                    <option value="Indian" {{ old('race', $doctor->race) == 'Indian' ? 'selected' : '' }}>Indian</option>
                                    <option value="Others" {{ old('race', $doctor->race) == 'Others' ? 'selected' : '' }}>Others</option>
                                </select>
                                @error('race')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control @error('maritalStatus') is-invalid @enderror" 
                                    ...
                                    <option value="Single" {{ old('maritalStatus', $doctor->maritalStatus) == 'Single' ? 'selected' : '' }}>Single</option>
                                    <option value="Married" {{ old('maritalStatus', $doctor->maritalStatus) == 'Married' ? 'selected' : '' }}>Married</option>
                                    <option value="Divorced" {{ old('maritalStatus', $doctor->maritalStatus) == 'Divorced' ? 'selected' : '' }}>Divorced</option>
                                    <option value="Widowed" {{ old('maritalStatus', $doctor->maritalStatus) == 'Widowed' ? 'selected' : '' }}>Widowed</option>
                                </select>
                                @error('maritalStatus')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="docIC">NRIC / Passport Number</label>
                                <input type="text" 
                                       class="form-control" 
                                       id="docIC" 
                                       name="docIC" 
                                       ...
                                       readonly>
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i> IC number cannot be changed for security reasons
                                </small>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" 
                                       ...
                                       readonly>
                                <small class="form-text text-muted">
                                    <i class="fas fa-info-circle"></i> Doctor ID is automatically assigned
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="docEmail">Email Address <span class="required">*</span></label>
                                <input type="email" 
                                       class="form-control @error('docEmail') is-invalid @enderror" 
                                       id="docEmail" 
                                       name="docEmail" 
                                       value="{{ old('docEmail', $doctor->docEmail) }}" 
                                       required>
                                @error('docEmail')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-envelope"></i> This email will be used for notifications
                                </small>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="docTel">Phone Number <span class="required">*</span></label>
                                <input type="tel" 
                                       class="form-control @error('docTel') is-invalid @enderror" 
                                       id="docTel" 
                                       name="docTel" 
                                       value="{{ old('docTel', $doctor->docTel) }}" 
                                       required>
                                @error('docTel')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control @error('address') is-invalid @enderror" 
                                          ...
                                          name="address" 
                                          rows="4" 
                                          placeholder="Enter your full address">{{ old('address', $doctor->address) }}</textarea>
                                @error('address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">
                                    <i class="fas fa-map-marker-alt"></i> Your complete residential address
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="security-info">
                            ...
                            <div class="security-item">
                                ...
                                <div class="security-content">
                                    <h5>Last Updated</h5>
                                    <p>Profile was last updated on {{ $doctor->updated_at->format('d/m/Y h:i A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-buttons">
                        ...
                        <a href="{{ route('doctor.profile') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const phoneInput = document.getElementById('docTel');
    ...
    function validateDateOfBirth(input) {
        ...
        if (value) {
            ...
            if (birthDate > today) {
                ...
                showFieldError(input, 'Doctor must be at least 18 years old');
                return false;
            } else {
                showFieldSuccess(input);
                return true;
