    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('patient.appointment.store') }}" method="POST" class="appointment-form" id="appointmentForm">
                    @csrf
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="patientName" name="patientName" value="{{ $patient->patientName }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="patientIC" name="patientIC" value="{{ $patient->patientIC }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="patientTel">Telephone Number</label>
                            <input type="tel" class="form-control" id="patientTel" name="patientTel" value="{{ $patient->patientTel }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Please provide any additional information or specific requirements for your appointment"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-buttons">
                        ...
                        <a href="{{ route('patient.appointment.list') }}" class="btn btn-secondary">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ===========================================
    // DATE AND TIME SLOT FUNCTIONALITY
    // ===========================================
    ...
    function updateAvailableTimeSlots() {
        ...
        fetch(`/patient/appointment/check-slots/${selectedDate}`)
            .then(response => {
                if (!response.ok) {
...
<style>
    /* Patient-specific styling for appointment creation form */
    .appointment-form {
        padding: 2rem;
    }
