        ...
        <div class="dashboard-content">
            <div class="content-container">
                <div class="appointment-header">
                    ...
                    <div class="add-new">
                        <a href="{{ route('staff.appointment.create') }}" class="add-appointment-btn">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            <div class="appointment-actions">
                                                <a href="{{ route('staff.appointment.show', $appointment->appID) }}" class="action-btn view-btn" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($appointment->status != 'cancelled')
                                                    <a href="{{ route('staff.appointment.edit', $appointment->appID) }}" class="action-btn edit-btn" title="Edit">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $('#cancelModal').on('show.bs.modal', function (event) {
            ...
            modal.find('#cancelForm').attr('action', `/staff/appointment/${appointmentId}/cancel`);
        });
