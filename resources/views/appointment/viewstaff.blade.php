        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <div class="action-buttons">
                    <a href="{{ route('staff.appointment.list') }}" class="btn btn-back">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                    <a href="{{ route('staff.appointment.edit', $appointment->appID) }}" class="btn btn-primary">
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p>Appointment was scheduled by Staff</p>
                                </div>
                            </div>
...
<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="cancelModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('staff.appointment.cancel', $appointment->appID) }}" method="POST">
                @csrf
                @method('PUT')
