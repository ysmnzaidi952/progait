    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <form action="{{ route('admin.appointment.update', $appointment->appID) }}" method="POST" class="appointment-form" id="appointmentForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="patientName" name="patientName" value="{{ $appointment->patient->patientName ?? 'Not specified' }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="patientIC" name="patientIC" value="{{ $appointment->patient->patientIC ?? 'Not specified' }}" readonly>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="patientTel">Telephone Number</label>
                            <input type="tel" class="form-control" id="patientTel" name="patientTel" value="{{ $appointment->patient->patientTel ?? 'Not specified' }}" readonly>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateAvailableTimeSlots() {
        ...
        fetch(`/admin/appointment/check-slots/${selectedDate}?exclude=${currentAppointmentId}`)
