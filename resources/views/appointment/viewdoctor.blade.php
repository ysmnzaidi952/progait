        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <div class="action-buttons">
                    <a href="{{ route('doctor.appointment.list') }}" class="btn btn-back">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                    @if($appointment->status != 'cancelled')
                        <a href="{{ route('doctor.appointment.edit', $appointment->appID) }}" class="btn btn-primary">
                ...
                <div class="appointment-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">{{ $appointment->typeAmputee ?? 'Not specified' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="appointment-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">{{ $appointment->medicalNotes ?? 'No medical notes provided' }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="appointment-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="info-row">
                            ...
                            <div class="info-value">{{ $appointment->notes ?? 'No additional notes provided' }}</div>
                        </div>
                        @if($appointment->status == 'completed' && $appointment->completionNotes)
                        <div class="info-row">
                            <div class="info-label">Completion Notes:</div>
                            <div class="info-value">{{ $appointment->completionNotes }}</div>
                        </div>
                        @endif
                        ...
                        <div class="timeline">
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p>Appointment was scheduled by {{ $appointment->createdBy ?? 'System' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p>Appointment details were modified by {{ $appointment->updatedBy ?? 'Staff' }}</p>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="timeline-date">{{ $appointment->completedAt ? date('d/m/Y h:i A', strtotime($appointment->completedAt)) : $appointment->updated_at->format('d/m/Y h:i A') }}</p>
                                    <p>Patient attended the appointment</p>
                                    @if($appointment->completionNotes)
                                    <p><strong>Notes:</strong> {{ $appointment->completionNotes }}</p>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <p class="timeline-date">{{ $appointment->cancelledAt ? date('d/m/Y h:i A', strtotime($appointment->cancelledAt)) : $appointment->updated_at->format('d/m/Y h:i A') }}</p>
                ...
                @if($patientHistory && count($patientHistory) > 0)
                <!-- Previous Appointments Card -->
                <div class="appointment-card">
                    <div class="card-header">
                        <h4><i class="fas fa-history"></i> Patient's Previous Appointments</h4>
                    </div>
                    <div class="card-body">
                        <table class="history-table">
                            ...
                            <tbody>
                                @foreach($patientHistory as $historyItem)
                                    @if($historyItem->appID != $appointment->appID)
                                    <tr>
                                        <td>{{ date('d/m/Y', strtotime($historyItem->appointmentDate)) }}</td>
                                        <td>{{ date('h:i A', strtotime($historyItem->appointmentTime)) }}</td>
                                        <td>
                                            @php
                                                $historyStatus = $historyItem->status ?? 'upcoming';
                                                $historyStatusClass = 'status-upcoming';
                                        ...
                                        <td>{{ Str::limit($historyItem->notes ?? 'No notes', 30) }}</td>
                                        <td>
                                            <a href="{{ route('doctor.appointment.show', $historyItem->id) }}" class="btn btn-sm btn-info">
...
<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="cancelModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{ route('doctor.appointment.cancel', $appointment->appID) }}" method="POST">
                @csrf
                @method('PUT')
