        ...
        <div class="dashboard-content">
            <div class="content-container">
                <div class="appointment-header">
                    ...
                    <div class="add-new">
                        <a href="{{ route('doctor.appointment.create') }}" class="add-appointment-btn">
                            ...
                            @if(isset($appointments) && count($appointments) > 0)
                                @foreach($appointments as $key => $appointment)
                                    <tr>
                                        ...
                                        <td data-label="Patient IC">{{ $appointment->patientIC }}</td>
                                        <td data-label="Telephone">{{ $appointment->patientTel }}</td>
                                        ...
                                        <td data-label="Action">
                                            <div class="appointment-actions">
                                                <a href="{{ route('doctor.appointment.show', $appointment->appID) }}" class="action-btn view-btn" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                @if($appointment->status != 'cancelled')
                                                    <a href="{{ route('doctor.appointment.edit', $appointment->appID) }}" class="action-btn edit-btn" title="Edit">
                                                ...
                                                @if($appointment->status != 'cancelled')
                                                    <form action="{{ route('doctor.appointment.cancel', $appointment->appID) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit" class="action-btn cancel-btn" title="Cancel Appointment" onclick="return confirm('Are you sure you want to cancel this appointment?')">
                                                            <i class="fas fa-times-circle"></i>
                                                        </button>
                                                    </form>
                                                @else
                                                    <button class="action-btn cancel-btn" title="Already Cancelled" style="opacity: 0.5; cursor: not-allowed;" disabled>
                                                        <i class="fas fa-times-circle"></i>
                                                    </button>
                                                @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        //     modal.find('#cancelForm').attr('action', `/doctor/appointment/${appointmentId}/cancel`);
        // });
...
<style>
    /* Additional style for the complete button */
