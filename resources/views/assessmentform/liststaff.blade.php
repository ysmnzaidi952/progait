        ...
        <div class="dashboard-content">
            <div class="content-container">
                <div class="assessment-header">
                    ...
                    <div class="add-new">
                        <a href="{{ route('staff.assessment.create') }}" class="add-assessment-btn">
                                    ...
                                    <tr>
                                        ...
                                        <td data-label="Action">
                                            <div class="assessment-actions">
                                                <a href="{{ route('staff.assessment.show', $assessment->formID) }}" class="action-btn view-btn" title="View">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('staff.assessment.edit', $assessment->formID) }}" class="action-btn edit-btn" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('staff.assessment.destroy', $assessment->formID) }}" method="POST" class="delete-form" onsubmit="return confirm('Are you sure you want to delete this assessment record for {{ $assessment->patient->patientName ?? 'this patient' }}?');">
                                                    @csrf
                                                    @method('DELETE')
