        ...
        <div class="dashboard-content">
            <div class="content-container">
                ...
                <div class="action-buttons">
                    <a href="{{ route('staff.assessment.list') }}" class="btn btn-back">
                        <i class="fas fa-arrow-left"></i> Back to List
                    </a>
                    <a href="{{ route('staff.assessment.edit', $assessment->formID) }}" class="btn btn-primary">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form action="{{ route('staff.assessment.destroy', $assessment->formID) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
