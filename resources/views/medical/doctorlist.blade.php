...
<body>
        ...
        <main class="dashboard-main">
            <div class="dashboard-header">
                <div class="header-left">
                    <h2>My Patient Medical Records</h2>
                </div>
                <div class="header-right">
                    ...
                    <div class="header-notifications">
                        <div class="notifications-icon">
                            <a href="{{ route('doctor.medical.create') }}" class="add-medical-btn">
                ...
                <div class="medical-table-container">
                    <div class="table-header">
                        <h3>
                            ...
                            <span class="record-count">({{ isset($medicalRecords) ? count($medicalRecords) : '18' }} records)</span>
                        </h3>
                        <div class="table-actions">
                            ...
                            <div class="filter-dropdown">
                                <select id="amputationFilter" class="filter-select">
                                    <option value="">All Amputations</option>
                    ...
                    <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr data-status="{{ $record->status }}"
                                        ...
                                        <td data-label="Record ID">
                                            <span class="record-id">{{ $record->record_id ?? 'MR' . str_pad($record->medID, 4, '0', STR_PAD_LEFT) }}</span>
                                        </td>
                                        ...
                                        <td data-label="Amputation">
                                            <div class="amputation-info">
                                                <strong>{{ $record->amputation_level }}</strong>
                                                <br>
                                                <small class="text-muted">
                                                    {{ $record->amputation_side }}<br>
                                                    {{ $record->amputation_date ? \Carbon\Carbon::parse($record->amputation_date)->format('M d, Y') : 'N/A' }}
                                                </small>
                                            </div>
                                        </td>
                                        <td data-label="K-Level & Health">
                                            <div class="prosthetic-assessment">
                                                <div class="assessment-row">
                                                    <span class="assessment-label">K:</span>
                                                    <span class="k-level-badge k-level-{{ strtolower($record->k_level) }}">
                                                        {{ $record->k_level }}
                                                    </span>
                                                </div>
                                                <div class="assessment-row">
                                                    <span class="assessment-label">H:</span>
                                                ...
                                                <div class="blart-score">
                                                    ...
                                                    <span class="blart-category
                                                        ...
                                                        @else blart-advanced
                                                        @endif">
                                                        @if($record->blart_score <= 10) Limited
                                                        @elseif($record->blart_score <= 20) Functional
                                                        @else Advanced
                                                        @endif
                                                    </span>
                                                </div>
                                        ...
                                        <td data-label="Next Checkup">
                                            @if($record->next_checkup_date)
                                                <span class="checkup-date">{{ \Carbon\Carbon::parse($record->next_checkup_date)->format('M d, Y') }}</span>
                                                <br>
                                                <small class="text-muted">
                                                    {{ \Carbon\Carbon::parse($record->next_checkup_date)->diffForHumans() }}
                                                </small>
                                            @else
                                        ...
                                        <td data-label="Actions">
                                            <div class="medical-actions">
                                                ...
                                                {{-- <a href="{{ route('doctor.medical.show', $record->medID) }}" class="action-btn view-btn" title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </a> --}}
                                                {{-- <a href="{{ route('doctor.medical.edit', $record->medID) }}" class="action-btn edit-btn" title="Edit Record">
                        ...
                        @else
                            ...
                            <div class="empty-state">
                                ...
                                <p>You haven't created any medical records yet. Create your first medical record to get started with patient management.</p>
                                <a href="{{ route('doctor.medical.create') }}" class="add-medical-btn">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        <strong>Warning:</strong> Deleting this medical record will permanently remove all associated medical data including prosthetic assessments.
                    </div>
                </div>
    ...
    <script>
        ...
        function deleteRecord(recordId) {
            ...
            deleteForm.action = `{{ route('doctor.medical.delete', '') }}/${recordId}`;
    ...
    <style>
        ...
        * {
        ...
        .medical-table th:nth-child(4), .medical-table td:nth-child(4) { width: 12%; } /* Amputation */
        .medical-table th:nth-child(5), .medical-table td:nth-child(5) { width: 18%; } /* K-Level & Health */
        .medical-table th:nth-child(6), .medical-table td:nth-child(6) { width: 10%; } /* Last Updated */
        .medical-table th:nth-child(7), .medical-table td:nth-child(7) { width: 12%; } /* Next Checkup */
        .medical-table th:nth-child(8), .medical-table td:nth-child(8) { width: 15%; } /* Actions */
        ...
        /* Patient Info Styling - More compact */
        .patient-info {
            display: flex;
            align-items: center;
            gap: 0.8rem;
        ...
        /* Prosthetic Assessment Column - More compact */
