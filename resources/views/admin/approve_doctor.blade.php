...
<head>
    ...
    <title>ProGait - Doctor Approval</title>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-content">
            ...
            <div class="content-container">
                <h1 class="page-title">Pending Doctor Registrations</h1>
                    ...
                    <tbody>
                        @foreach ($pendingDoctors as $doctor)
                            <tr>
                                ...
                                <td><span class="status-pending">{{ $doctor->status }}</span></td>
                                <td>
                                    <form action="{{ route('admin.approve-doctor', ['docID' => $doctor->docID]) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                ...
                @if(count($pendingDoctors) == 0)
                    <div class="empty-state">
                        ...
                        <p>No pending doctor registrations at the moment.</p>
                    </div>
                @endif
