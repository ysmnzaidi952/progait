                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="staff-actions">
                                        <a href="{{ route('staff.patient.patientviewstaff', $patient->patientID) }}" class="action-btn view-btn" title="View Details">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('staff.patient.patientupdatestaff', $patient->patientID) }}" class="action-btn edit-btn" title="Edit Patient">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('staff.patient.deletestaff', $patient->patientID) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
