            ...
            <div class="content-container">
                ...
                <div class="profile-view-header">
                    ...
                    <div class="profile-actions">
                        <a href="{{ route('staff.patient.patientupdatestaff', $patient->patientID) }}" class="btn btn-primary">
                ...
                <div class="appointment-actions">
                    <a href="{{ route('staff.patient.patientliststaff') }}" class="btn btn-primary">
...
<style>
    /* Same styling as admin patient view */
    .profile-view-header {
        display: flex;
